...
class InnScreen extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
                ...
                <ScrollView>
                    <View style={styles.content_global}>
                        ...
                        <Button title="Далее" onPress={() => {
                            this.props.navigation.navigate('CompanyYearScreen')
                        }}/>
...
export default connect(mapStateToProps, mapDispatchToProps)(InnScreen);