...
import { SetName } from "../../../../actions/user_summary/View";
import Svg, {Path} from "react-native-svg";
import StatusBarComp from "../../../../components/StatusBarComp";

class UserSummaryViewNameScreen extends Component {
    ...
    static navigationOptions = ({ navigation }) => NavigationOptions(navigation, {title: 'НАИМЕНОВАНИЕ ОБЪЯВЛЕНИЯ', left_func: 'UserSummaryViewIndexScreen', margin_top: false});
        ...
        return(
            <SafeAreaView style={styles.container_global}>
                <StatusBarComp/>
                    ...
                    <ScrollView>
                       <View style={styles.content_global}>
                           ...
                           <Text style={{color: '#262626', fontSize: verticalScale(14), fontFamily: 'PFBeauSansPro-Regular',}}>Название объявления будете видеть только Вы. На основе шаблона Вы сможете размещать объявления в календаре на новые даты</Text>
                ...
                <View style={{position:'absolute', bottom:20, right:20,}}>
                    <Button full primary style={[styles.button, {width: 50,}]} onPress={() => this.props.navigation.navigate('UserSummaryViewIndexScreen')}>
...
export default connect(mapStateToProps, mapDispatchToProps)(UserSummaryViewNameScreen);