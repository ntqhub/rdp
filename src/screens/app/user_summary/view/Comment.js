...
import {SetComment} from "../../../../actions/user_summary/View";
import Svg, {Path} from "react-native-svg";
import StatusBarComp from "../../../../components/StatusBarComp";

class UserSummaryViewCommentScreen extends Component {
    ...
    static navigationOptions = ({ navigation }) => NavigationOptions(navigation, {title: 'КОММЕНТАРИЙ', left_func: 'UserSummaryViewIndexScreen', margin_top: false});
        ...
        return(
            <SafeAreaView style={styles.container_global}>
                <StatusBarComp/>
                    ...
                    <ScrollView>
                       <View style={styles.content_global}>
                           ...
                           <Text style={{color: '#262626', fontSize: verticalScale(14), fontFamily: 'PFBeauSansPro-Regular',}}>Введите комментарий к объявлению или пожелания. Этот поможет заказчику больше узнать о объявлении.</Text>

                           <View style={{marginTop:15, flex:1, borderColor: '#074A5D', borderWidth: 1, borderRadius: 5, borderStyle: 'dashed',}}>
                               <Item>
                                   <Input
                                       style={{color: '#262626', fontFamily: 'PFBeauSansPro-Regular', borderBottomWidth: 0,}}
                                       autoCapitalize="sentences"
                                       autoCorrect={false}
                                       multiline={true}
                                       numberOfLines={5}
                                       onChangeText={(value) => this.props.SetComment(value)}
                                       placeholder="Введите текс здесь"
                ...
                <View style={{position:'absolute', bottom:20, right:20,}}>
                    <Button full primary style={[styles.button, {width: 50,}]} onPress={() => this.props.navigation.navigate('UserSummaryViewNameScreen')}>
...
export default connect(mapStateToProps, mapDispatchToProps)(UserSummaryViewCommentScreen);