...
class SearchFavoritesScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            count: 0,
            ...
            >
                ...
                <FlatList
                    ...
                    renderItem={({item, index}) => {
                        return (
                            <SearchBlock item={item} favoritesList={true}/>
                        );
                    }}
                />
...
export default connect(mapStateToProps, mapDispatchToProps)(withNavigationFocus(SearchFavoritesScreen));